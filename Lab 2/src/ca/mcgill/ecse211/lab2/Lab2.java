...
public class Lab2 {
  // Wheel Radius: 2.2cm; Diameter: 4.4cm
  // Wheel Base: 10.2cm 
  ...
  private static final EV3ColorSensor redSensor = new EV3ColorSensor(LocalEV3.get().getPort("S1")); // Initialize a light sensor.
  
  private static final TextLCD lcd = LocalEV3.get().getTextLCD();
  
  /**
   * Initialize the wheel radius and the wheel base(TRACK), the track was modified from 10.2 cm to 
   * 9.8 cm in order to make the robot go straight and turn with a relatively perfect 90 degrees. 
   * 
  ...
  public static void main(String[] args) throws OdometerExceptions {
    ...
    OdometryCorrection odometryCorrection = new OdometryCorrection(redSensor); // TODO Complete
                                                                      // implementation
