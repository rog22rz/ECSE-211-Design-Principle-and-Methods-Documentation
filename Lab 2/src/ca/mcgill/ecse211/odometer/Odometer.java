...
public class Odometer extends OdometerData implements Runnable {
  ...
  public void run() {
    ...
    while (true) {
       ...
       * However, the taco counts are in degrees. Therefore needs to devided by 360 degrees.  
       */
       ...
       * Therefore it has to be converted to degrees to be storeds as the coordinates.  
       */
